...
type TcpSliceRouterHandler struct {
	coreFunc func(*TcpSliceRouterContext) tcp_details.TcpHandler
...
func NewTcpSliceRouterHandler(coreFunc func(*TcpSliceRouterContext) tcp_details.TcpHandler, router *TcpSliceRouter) *TcpSliceRouterHandler {
